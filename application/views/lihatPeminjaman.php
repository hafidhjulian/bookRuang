    ...
    <div class="container">
        ...
        <div class="row">
            <table class="table-responsive">
                ...
                <?php 
                    $no = 1;
                    foreach($lihat_peminjaman as $lihat){ 
                ?>
                    <tr>
                        <td><?php echo $no++;?></td>
                        <td><?php echo $lihat->id_user?></td>
                        <td><?php echo $lihat->nama_peminjam?></td>
                        <td><?php echo $lihat->nama_dosen ?></td>
                        <td><?php echo $lihat->nama_makul ?></td>
                        <td><?php echo $lihat->tanggal ?></td>
                        <td><?php echo $lihat->jam ?></td>
                        <td><?php echo $lihat->nama_ruangkelas ?></td>
                    </tr>
                </tbody>
                    <?php } ?>
            </table>
