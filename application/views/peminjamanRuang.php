...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col s6">
                <?php echo form_open('welcome/proses_pesan')?>
                <input type="hidden" name="id_user" value="<?php echo $this->session->userdata("nim")?>">
                ...
                <div class="row input-field">
                    ...
                    <input id="last_name" type="text" class="validate" name="ruangkelas"required>
                </div> 
                <div class="row input-field">
